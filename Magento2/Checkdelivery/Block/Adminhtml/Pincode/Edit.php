<?php
namespace Bluethink\Checkdelivery\Block\Adminhtml\Pincode;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    protected function _construct()
    {
        ...
        $this->buttonList->update('save', 'label', __('Save CSV'));
        $this->buttonList->update('delete', 'label', __('Delete CSV'));
