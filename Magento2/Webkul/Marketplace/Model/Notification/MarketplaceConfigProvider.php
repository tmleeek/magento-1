...
class MarketplaceConfigProvider
{
    ...
    public function getConfig()
    {
        if ($this->isAdminLoggedIn()) {
            $defaultImageUrl = $this->viewFileSystem->getUrlWithParams('Webkul_Marketplace::images/icons_notifications.png', []);
        ...
        if ($markeplaceProduct->getSize()) {
            foreach ($markeplaceProduct as $value) {
                ...
                $productData[] = [
                    ...
                    'updated_time'  => $this->date->gmtDate('l jS \of F Y h:i:s A', strtotime($value->getUpdatedAt())),
        ...
        if ($sellerCollection->getSize()) {
            foreach ($sellerCollection as $seller) {
                ...
                $sellerData[] = [
                    ...
                    'updated_time'  => $this->date->gmtDate('l jS \of F Y h:i:s A', strtotime($seller->getUpdatedAt())),
        ...
        if ($feedBackCollection->getSize()) {
            foreach ($feedBackCollection as $feedback) {
                ...
                $feedBackData[] = [
                    ...
                    'updated_time'  => $this->date->gmtDate('l jS \of F Y h:i:s A', strtotime($feedback->getCreatedAt())),
