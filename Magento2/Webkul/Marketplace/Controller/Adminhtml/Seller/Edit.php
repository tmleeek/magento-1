...
class Edit extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Webkul_Marketplace::marketplace_seller')
            ->addBreadcrumb(__('Marketplace'), __('Marketplace'))
            ->addBreadcrumb(__('Manage Seller'), __('Manage Seller'));
        return $resultPage;
    }
    ...
    public function execute()
    {
        ...
        if ($id) {
            $sellerId = 0;
            foreach ($model->getCollection() as $seller) {
        ...
        $resultPage->getConfig()->getTitle()
            ->prepend($model->getId() ? $model->getTitle() : __('Seller Information'));
        $resultPage->addContent(
            $resultPage->getLayout()->createBlock(
                'Webkul\Marketplace\Block\Adminhtml\Seller\Edit'
            )
        );
        $resultPage->addLeft(
            $resultPage->getLayout()->createBlock(
                'Webkul\Marketplace\Block\Adminhtml\Seller\Edit\Tabs'
            )
        );
