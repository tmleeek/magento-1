...
/**
 * Webkul MpTwilioSMSNotification MpDisapproveProductObserver Observer.
 */
class MpDisapproveProductObserver implements ObserverInterface
{
    ...
    /**
     * mp_disapprove_product event handler.
     *
    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        if ($this->_helperData->getTwilioStatus()) {
            ...
            foreach ($mpSellerCollection as $mpSeller) {
                ...
                $body = __(
                    "Hi %1, your product %2 disapproved by admin",
                    $sellerName,
                    $productName
                );
                try {
