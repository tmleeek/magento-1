...
/**
 * Webkul MpTwilioSMSNotification MpApproveProductObserver Observer.
 */
class MpApproveProductObserver implements ObserverInterface
{
    ...
    /**
     * mp_approve_product event handler.
     *
    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        if ($this->_helperData->getTwilioStatus()) {
            ...
            $productName =  $this->_productModel
            ...
            foreach ($mpSellerCollection as $mpSeller) {
                ...
                $body = __(
                    "Hi %1, your product '%2' approved by Admin ",
                    $sellerName,
                    $productName
                );
