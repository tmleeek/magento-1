 ...
 */
class Draft extends \Magento\Framework\Model\AbstractModel implements IdentityInterface
{
    const CACHE_TAG = 'helpdesk_draft';
    /**
     * @var string
     */
    protected $_cacheTag = 'helpdesk_draft';
