...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    protected function _prepareColumns()
    {
        ...
        if (in_array('priority_id', $columns)) {
         ...
         if (in_array('version', $columns) && !$this->getTabMode()) {
            $this->addColumn('help_version', [
                    'header' => __('Version'),
                    'index' => 'help_version',
        ...
        if (in_array('os', $columns) && !$this->getTabMode()) {
            $this->addColumn('help_os', [
                    'header' => __('OS'),
                    'index' => 'help_os',
         ...
         if (in_array('product', $columns) && !$this->getTabMode()) {
            $this->addColumn('help_product', [
                    'header' => __('Product'),
                    'index' => 'help_product',
        ...
        if (in_array('serialnumber', $columns) && !$this->getTabMode()) {
            $this->addColumn('help_serialnumber', [
                    'header' => __('Serial Number'),
                    'index' => 'help_serialnumber',
