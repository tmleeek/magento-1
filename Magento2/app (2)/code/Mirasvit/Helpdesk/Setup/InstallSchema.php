...
class InstallSchema implements InstallSchemaInterface
{
    ...
    public function install(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        foreach ($data as $row) {
            $setup->getConnection()->insertForce($setup->getTable('mst_helpdesk_department'), $row);
        }
        ...
        $data = [
            [
                'du_department_id' => 1,
                'du_user_id' => 1,/* @fixme fetch real user id */
            ],
            [
                'du_department_id' => 2,
                'du_user_id' => 1, /* @fixme fetch real user id */
        ...
        $data = [
            [
                'ds_department_id' => 1,
                'ds_store_id' => 1,/* @fixme fetch real store id */
            ],
            [
                'ds_department_id' => 2,
                'ds_store_id' => 1, /* @fixme fetch real store id */
        ...
        $data = [
            [
                'ps_priority_id' => 1,
                'ps_store_id' => 1,/* @fixme fetch real store id */
            ],
            [
                'ps_priority_id' => 2,
                'ps_store_id' => 1, /* @fixme fetch real store id */
        ...
        $data = [
            [
                'ss_status_id' => 1,
                'ss_store_id' => 1,/* @fixme fetch real store id */
            ],
            [
                'ss_status_id' => 2,
                'ss_store_id' => 1, /* @fixme fetch real store id */
